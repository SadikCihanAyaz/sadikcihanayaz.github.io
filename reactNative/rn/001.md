...
- Render patterns: render props, higher-order components, component composition
...
- Platform quirks: iOS vs Android styling, KeyboardAvoidingView / keyboard handling, Permissions
...
- Navigation hooks: useNavigation, useRoute (ties back to React Navigation)
...
- Linking & deep linking: Linking API, universal links / app links

- Accessibility: accessible props, accessibilityLabel, roles, focus management

- Native modules basics: Platform module, PermissionsAndroid, interaction with native APIs
